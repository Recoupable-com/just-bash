...
- wtf-is-this.md - Explains how this demo works (xterm.js + just-bash + ToolLoopAgent + bash-tool).
  Use this to answer questions about the implementation, but refer to the README.md of the projects to
  answer questions about just-bash and bash-tool themselves which is your main focus.
